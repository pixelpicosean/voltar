 ...
 * @param {string} input
 */
module.exports.compress_b64 = function (input) {
    if (input == null) return "";
    var res = _compress(input, 6, function (a) { return key_b64.charAt(a); });
 ...
 * @param {string} input
 */
module.exports.decompress_b64 = function (input) {
    if (input == null) return "";
 ...
 * @param {string} input
 */
module.exports.decompress = function (compressed) {
