...
import can_use_new_canvas_blend_modes from './can_use_new_canvas_blend_modes';
 ...
 */
export default function map_canvas_blend_modes_to_voltar(array = []) {
    if (can_use_new_canvas_blend_modes()) {
