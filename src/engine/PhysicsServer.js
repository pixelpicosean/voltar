 ...
 */
function is_separating_axis(a_pos, b_pos, a_points, b_points, axis, response) {
                        ...
                        if (!(
                            ...
                            // Area vs Body or Area vs Area
                                ...
                                for (let i = 0; i < shape.normals.length; i++) {
                                    if (is_separating_axis(a_pos, b_pos, a_points, b_points, shape.normals[i], undefined)) {
                                        separated = true;
                                        break;
                                    }
                                }
                                ...
                                for (let i = 0; i < shape2.normals.length; i++) {
                                    if (is_separating_axis(a_pos, b_pos, a_points, b_points, shape2.normals[i], undefined)) {
                                        separated = true;
                                        break;
                                    }
                                }
