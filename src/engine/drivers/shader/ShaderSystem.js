 ...
 */
export default class ShaderSystem
{
    /**
     ...
     * @returns {GLProgram} the glProgram that belongs to the shader.
     */
     ...
     *
     * @param {UniformGroup} group the uniform group to get signature of
     ...
     *
     * @return {GLProgram} the glProgram for the currently bound Shader for this context
     */
    getglProgram()
    {
        if (this.shader)
     ...
     *
     * @private
     * @param {Shader} shader the shader that the glProgram will be based on.
     * @return {GLProgram} A shiny new glProgram!
     */
