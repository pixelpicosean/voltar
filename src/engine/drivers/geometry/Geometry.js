...
{
    /**
     * @param {Buffer[]} [buffers]  an array of buffers. optional.
    ...
    * @param {Number} [type=TYPES.FLOAT] what type of number is the attribute. Check {TYPES} to see the ones available
    ...
    */
     ...
     * @return {Attribute} the attribute requested.
     */
    getAttribute(id)
    {
    ...
    */
     ...
     *
     * @returns {Geometry} a new clone of this geometry
     */
    clone()
    {
     ...
     *
     * @param {Geometry[]} geometries array of geometries to merge
     * @returns {Geometry} shiny new geometry!
     */
