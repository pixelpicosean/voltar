...
HowlerGlobal.prototype = {
     ...
     * @return {HowlerGlobal|number}     Returns self or current volume.
     */
    volume: function (vol) {
        var self = this;
 ...
 */
export const Howl = function Howl(o) {
    var self = this;
...
Howl.prototype = {
    ...
    play: function (sprite, internal) {
        ...
        if (self._webAudio) {
            ...
            var playHtml5 = function () {
                ...
                // @ts-ignore
                node.volume = sound._volume * /** @type {number} */(Howler.volume());
                // @ts-ignore
    ...
    pause: function (id) {
        ...
        for (var i = 0; i < ids.length; i++) {
            ...
            if (sound && !sound._paused) {
                ...
                sound._seek = /** @type {number} */(self.seek(ids[i]));
                sound._rateSeek = 0;
                sound._paused = true;
            ...
            for (var i = 0; i < id.length; i++) {
                ...
                if (sound) {
                    ...
                    if (self._webAudio && sound._node && !sound._muted) {
                        ...
                        // @ts-ignore
                        sound._node.volume = vol * /** @type {number} */(Howler.volume());
                    }
     ...
     * @param  {Sound} sound Reference to sound to fade.
     * @param  {number} from The value to fade from (0.0 to 1.0).
     * @param  {number} to   The volume to fade to (0.0 to 1.0).
     * @param  {number} len  Time in milliseconds to fade.
            ...
            for (var i = 0; i < id.length; i++) {
                ...
                if (sound) {
                    ...
                    if (self.playing(id[i])) {
                        sound._rateSeek = /** @type {number} */(self.seek(id[i]));
     ...
     * @param  {number} id Sound ID
     * @return {Sound}    Sound object or null.
     */
     ...
     * @param  {GainNode} node Sound's audio node containing the buffer source.
     * @return {Howl}
     */
     ...
     * @param  {any} node Audio node to clear.
     */
...
Sound.prototype = {
    ...
    create: function () {
        ...
        if (parent._webAudio) {
            ...
            // @ts-ignore
            self._node.volume = volume * /** @type {number} */(Howler.volume());
