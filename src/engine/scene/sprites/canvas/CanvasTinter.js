...
import can_use_new_canvas_blend_modes from '../../../renderers/canvas/utils/can_use_new_canvas_blend_modes';
...
const CanvasTinter = {
    ...
    getTintedTexture: (sprite, color) =>
    {
        ...
        if (cachedTexture)
        {
            if (cachedTexture.tintId === texture._update_id)
            {
        ...
        canvas.tintId = texture._update_id;
     ...
     * @type {boolean}
     */
    canUseMultiply: can_use_new_canvas_blend_modes(),
