...
export class Light extends VisualInstance {
     ...
     */
    set_light_color(p_color: ColorLike) {
     ...
     * @param {number} a
     */
    set_light_color_n(r: number, g: number, b: number, a: number) {
     ...
     */
    set_light_energy(p_energy: number) {
     ...
     */
    set_light_negative(p_enable: boolean) {
     ...
     */
    set_shadow_color(p_shadow_color: ColorLike) {
     ...
     * @param {boolean} p_enable
     */
    set_shadow_enabled(p_enable: boolean) {
...
export class DirectionalLight extends Light {
     ...
     * @param {boolean} p_enable
     */
    set_directional_blend_splits(p_enable: boolean) {
     ...
     * @param {number} mode
     */
    set_directional_shadow_mode(mode: number) {
     ...
     * @param {number} range
     */
    set_directional_shadow_depth_range(range: number) {
...
export class OmniLight extends Light {
     ...
     */
    set_shadow_detail(p_detail: number) {
