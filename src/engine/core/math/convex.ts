...
export function decompose_in_convex(vertices: Vector2[]) {
    /** @type {Vector2[]} */
    var vec: Vector2[] = [];
    var i = 0, n = 0, j = 0;
 ...
 * @param {number} y4
 */
function hit_ray(x1: number, y1: number, x2: number, y2: number, x3: number, y3: number, x4: number, y4: number) {
 ...
 * @param {number} y4
 */
function hit_segment(x1: number, y1: number, x2: number, y2: number, x3: number, y3: number, x4: number, y4: number) {
    var t1 = x3 - x1, t2 = y3 - y1, t3 = x2 - x1, t4 = y2 - y1, t5 = x4 - x3, t6 = y4 - y3, t7 = t4 * t5 - t3 * t6, a;
 ...
 * @param {number} y2
 */
function is_on_segment(px: number, py: number, x1: number, y1: number, x2: number, y2: number) {
 ...
 * @param {number} y2
 */
function points_match(x1: number, y1: number, x2: number, y2: number) {
 ...
 * @param {number} y2
 */
function is_on_line(px: number, py: number, x1: number, y1: number, x2: number, y2: number) {
 ...
 * @param {number} y3
 */
function det(x1: number, y1: number, x2: number, y2: number, x3: number, y3: number) {
